import type { PhotoItem, PhotosFace, PhotosPerson, PhotoView } from '~/tinycld/photos/types'
...
export function photoPerson(id: string, overrides: Partial<PhotosPerson> = {}): PhotosPerson {
    return {
        id,
        name: `Person ${id}`,
        thumbnail_face: null,
