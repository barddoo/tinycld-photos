...
const OPTIONS: {
...
}[] = [
	{
		...
		description:
			"Smaller thumbnails (1024px, 75% quality). Saves space on your server.",
	},
	{
		value: "high",
		label: "Keep Originals",
		description:
			"Larger thumbnails (2048px, 92% quality). Better fidelity when browsing.",
	},
];
		...
		<ScrollView style={{ flex: 1, backgroundColor: bg }}>
			<View className="px-4 pt-6 pb-4">
				<View className="flex-row items-center gap-2 mb-2">
					...
					<Text style={{ color: fg, fontSize: 20, fontWeight: "600" }}>
						Storage
					</Text>
				</View>
				<Text style={{ color: muted, fontSize: 13 }}>
					Controls the quality of thumbnails generated when photos are uploaded.
					Existing thumbnails are not regenerated when this setting changes.
				</Text>
			</View>
			...
			>
				Applies to new uploads only. Re-upload photos to regenerate existing
				thumbnails.
			</Text>
		</ScrollView>
	);
