...
const PersonCard = memo(function PersonCard({ person, size, onPress }: PersonCardProps) {
    ...
    return (
        ...
        >
            ...
            >
                {thumbnailUrl ? (
                    ...
                    <View className="flex-1 items-center justify-center">
                        <Text style={{ color: muted, fontSize: size * 0.38, fontWeight: '600' }}>
            ...
            <Text
                numberOfLines={1}
                style={{ color: fg, fontSize: 12, fontWeight: '500', marginTop: 6, maxWidth: size }}
            >
                {person.name}
            </Text>
        </Pressable>
