...
export default function DuplicatesScreen() {
	...
	const fetchDuplicates = useCallback(async () => {
		try {
			const resp = await pb.send("/api/photos/ml/duplicates", {
				method: "GET",
			});
			...
			>
				...
				>
					...
					>
						...
						<Text
							style={{ color: destructive, fontSize: 12, fontWeight: "500" }}
						>
							Delete extras
						</Text>
					</Pressable>
	...
	if (groups.length === 0) {
		return (
			...
			>
				...
				>
					No duplicate photos found. Enable perceptual hashing to find
					duplicates.
				</Text>
			</View>
		);
