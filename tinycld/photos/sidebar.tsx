...
const NAV_ITEMS: NavItem[] = [
	...
	{ section: "albums", label: "Albums", icon: Grid3X3, route: "photos/albums" },
	{
		...
		label: "Favorites",
		icon: Heart,
		route: "photos?section=favorites",
	},
];
...
function getSectionFromPath(pathname: string): ActiveSection {
	...
	if (pathname.includes("/search") || pathname.endsWith("/search"))
		return "search";
	if (pathname.includes("/people") || pathname.endsWith("/people"))
		return "people";
	if (pathname.includes("/memories") || pathname.endsWith("/memories"))
		return "memories";
